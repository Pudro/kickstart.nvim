...
-- -- Point Neovim to the python virtual environment
...
-- Set the different colored column at:
...
-- Keybinds to move over wrapped lines naturally
-- and ignore when jumping to line e.g. 3j
